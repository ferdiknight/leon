...
public class TestElement extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder newBuilder() {
    return new com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder();
  }
  
  /** Creates a new TestElement RecordBuilder by copying an existing Builder */
  public static com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder newBuilder(com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder other) {
    return new com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder(other);
  }
  
  /** Creates a new TestElement RecordBuilder by copying an existing TestElement instance */
  public static com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder newBuilder(com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement other) {
    return new com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TestElement>
    ...
    private Builder() {
      super(com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing TestElement instance */
    private Builder(com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement other) {
            super(com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.SCHEMA$);
    ...
    /** Sets the value of the 'name' field */
    public com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder setName(java.lang.CharSequence value) {
    ...
    public com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'id' field */
    public com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder setId(int value) {
    ...
    public com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder clearId() {
    ...
    /** Sets the value of the 'timestamp' field */
    public com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder setTimestamp(long value) {
    ...
    public com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'score' field */
    public com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder setScore(float value) {
    ...
    public com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder clearScore() {
    ...
    /** Sets the value of the 'terms' field */
    public com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder setTerms(java.util.List<java.lang.CharSequence> value) {
    ...
    public com.blueferdi.leon.demo.typeahead.serializer.nat.TestElement.Builder clearTerms() {
      terms = null;
